...
var semesterInfo = {
    ...
    firstDayOfSemester: new Date("01/12/2026 4:00:00"),
    lastDayOfSemester:  new Date("04/27/2026 4:00:00"),
    ...
    vacationDates: [
        new VacationDays("MLK Day", new Date("01/19/2026"), new Date("01/19/2026")),
        new VacationDays("Winter Break", new Date("02/28/2026"), new Date("03/08/2026")),
    ]
};
